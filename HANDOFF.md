...
- `master` ships everything described here. Latest release is `v1.0.2`; the pinned resource collator landed after it and is **unreleased on purpose** — too small to cut a build for, waiting for more to pile up.
